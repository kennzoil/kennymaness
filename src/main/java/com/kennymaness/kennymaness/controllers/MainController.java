...
import com.kennymaness.kennymaness.services.*;
...
public class MainController {
    ...
    /** This handler method merely renders the homepage template. */
    @GetMapping("/")
    public String renderHomepage(Model model) {

        String username = "kennzoil";
        HashMap<String, String> user = UserService.findByUsername(username);
